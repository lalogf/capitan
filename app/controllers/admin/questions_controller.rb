class Admin::QuestionsController < ApplicationController
  ...
  def destroy
    @question.destroy
    respond_to do |format|
      format.html { redirect_to [:admin,@question], notice: 'Question was successfully destroyed.' }
  ...
  private
    ...
    def question_params
      params.require(:question).permit(:description, options_attributes: [ :id,:correct, :description, :_destroy])
    end
end
