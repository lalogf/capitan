class Admin::CoursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course.save
        format.html { redirect_to [:admin,@track,@course], notice: 'Course was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @course.update(course_params)
        format.html { redirect_to [:admin,@track,@course], notice: 'Course was successfully updated.' }
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:name,:description,:avatar,:color,:background_image,:code, :points, :course_plan, :level, :audience)
    end
end
