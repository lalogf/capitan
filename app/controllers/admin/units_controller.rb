class Admin::UnitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @unit.save
        format.html { redirect_to [:admin,@track,@course], notice: 'Unit was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @unit.update(unit_params)
        format.html { redirect_to [:admin,@track,@course], notice: 'Unit was successfully updated.' }
  ...
  def destroy
    ...
    @unit.destroy
    respond_to do |format|
      format.html { redirect_to [:admin,@track,@course], notice: 'Unit was successfully destroyed.' }
