class Admin::BadgesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @badge.save
        format.html { redirect_to admin_badges_path, notice: 'Badge creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @badge.update(badge_params)
        format.html { redirect_to admin_badges_path, notice: 'Badge actualizado exitosamente.' }
