class Admin::LessonsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lesson.save
        format.html { redirect_to [:admin,@track,@course,@unit], notice: 'Lesson was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @lesson.update(lesson_params)
        format.html { redirect_to [:admin,@track,@course,@unit], notice: 'Lesson was successfully updated.' }
  ...
  def destroy
    ...
    @lesson.destroy
    respond_to do |format|
      format.html { redirect_to admin_track_course_unit_url(@track,@course, @unit), notice: 'Lesson was successfully destroyed.' }
