...
Spot.find_or_create_by(name: "Martes 22 de noviembre - 6:00pm a 9:00pm", branch:lima)
Spot.find_or_create_by(name: "Miércoles 23 de noviembre - 6:00pm a 9:00pm", branch:lima)
Spot.find_or_create_by(name: "Jueves 24 de noviembre - 6:00pm a 9:00pm", branch:lima)
Spot.find_or_create_by(name: "Sábado 26 de noviembre - 10:00am a 1:00pm", branch:lima)
Spot.find_or_create_by(name: "Sábado 26 de noviembre - 2:00pm a 5:00pm", branch:lima)
Spot.find_or_create_by(name: "Domingo 27 de noviembre - 10:00am a 1:00pm", branch:lima)
Spot.find_or_create_by(name: "Domingo 27 de noviembre - 2:00pm a 5:00pm", branch:lima)
Spot.find_or_create_by(name: "Martes 29 de noviembre - 6:00pm a 9:00pm", branch:lima)
Spot.find_or_create_by(name: "Miércoles 30 de noviembre - 6:00pm a 9:00pm", branch:lima)
Spot.find_or_create_by(name: "Jueves 01 de diciembre - 6:00pm a 9:00pm", branch:lima)
